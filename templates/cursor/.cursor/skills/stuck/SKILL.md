---
name: stuck
description: Break out of a failing loop with structured escalation when the same approach has failed twice or more. Use when the agent is looping on the same error, repeated fixes are not working, or the user says it is stuck.
---
