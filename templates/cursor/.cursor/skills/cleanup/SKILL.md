---
name: cleanup
description: Remove dead code, debug artifacts, and unused imports from the project. Use when the user asks to clean up code, remove debug logs, delete commented-out blocks, or before a commit to tidy up the workspace.
---
