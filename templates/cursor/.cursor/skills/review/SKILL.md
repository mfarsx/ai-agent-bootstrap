---
name: review
description: Self-review all uncommitted changes before committing, checking for bugs, debug junk, error handling, security, and consistency. Use when the user asks for a code review, wants to review a diff, or before running commit.
---
