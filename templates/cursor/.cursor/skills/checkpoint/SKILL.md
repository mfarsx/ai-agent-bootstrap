---
name: checkpoint
description: Save current progress snapshot to the memory bank. Use when creating a mid-session recovery point, before complex or risky changes, during long context windows, or when the user asks to checkpoint progress.
---
